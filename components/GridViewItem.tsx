...
function GridViewItem({
  ...
  const gridViewFileInput = 'grid-view-file-input';
  ...
  return (
    <div
      ...
      className={`h-full flex flex-col relative px-[24px] py-[18px] gap-[18px] items-center bg-black/25 ${
        showOptionsMenu ? '' : 'hover:bg-black/50'
      } group border-[1px] border-backgroundGray rounded-sm cursor-pointer`}>
      <div
        className={`w-full m-[12px] aspect-square flex justify-centere items-center relative`}>
      ...
      <div className={`flex-1 w-full flex flex-col`}>
        <div className={`overflow-hidden flex-1`}>
          <p
            ...
            } text-[12px] md:text-[14px] line-clamp-2 font-bold overflow-x-scroll`}>
